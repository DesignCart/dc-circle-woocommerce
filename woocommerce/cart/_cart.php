						...
						<td class="product-quantity" data-title="<?php esc_attr_e('Quantity', 'woocommerce'); ?>">
							...
							<div class="dc-qty-wrapper">
								...
								<input type="number"
									...
									max="<?php echo esc_attr($max_quantity > 0 ? $max_quantity : ''); ?>"
						...
						<td class="product-remove">
							<?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><img src="'.get_stylesheet_directory_uri().'/img/trash.svg" alt="Usuń" class="dc-cart-remove-icon" /></a>',
