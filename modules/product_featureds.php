    ...
    <?php if ( $products_query->have_posts() ) : ?>
        <div class="container">
            <div id="products-carousel-featureds" class="dc-products-carousel-module">
                <h2><?php echo esc_html( get_theme_mod( 'designcart_slider_feat_title', __( 'Polecane produkty', 'designcart' ) ) ); ?></h2>
...
<script>
    jQuery(document).ready(function($){
        var $carousel = $('.dc-products-carousel-featureds');
        ...
        $('#products-carousel-featureds .dc-owl-prev').click(function() {
            $carousel.trigger('prev.owl.carousel');
        });

        $('#products-carousel-featureds .dc-owl-next').click(function() {
